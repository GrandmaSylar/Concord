...
export default function AIAssistantWidget({ onInsertDraft, context, isOpen, setIsOpen }: AIAssistantWidgetProps) {
  ...
  const widgetContent = (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3 max-w-[calc(100vw-32px)]">
          ...
          <div className="px-4 py-3 border-b border-slate-100 bg-gradient-to-r from-violet-50 to-fuchsia-50 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <button 
                ...
                className="p-1 hover:bg-slate-200/50 rounded-md transition-colors cursor-pointer"
                title="Collapse"
              >
          ...
          <div className="p-4 space-y-3.5 max-h-[360px] overflow-y-auto">
            <div>
              ...
              <textarea
                ...
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400 transition-all resize-none bg-white"
              />
            </div>
              ...
              <div className="space-y-2 pt-2 border-t border-slate-100">
                ...
                {drafts.map((draft, i) => (
                  <button
                    ...
                    className="w-full text-left p-3 rounded-lg border border-slate-200 hover:border-violet-300 hover:bg-violet-50/30 transition-all group cursor-pointer bg-white"
                  >
  ...
  // Render via portal to escape overflow-hidden scroll containers
