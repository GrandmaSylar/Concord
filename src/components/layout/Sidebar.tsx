...
export default function Sidebar({ mobileOpen, setMobileOpen }: SidebarProps) {
 ...
 {item.name}
  ...
  <div className="hidden md:flex md:flex-shrink-0 relative z-10">
    <div className="flex flex-col bg-slate-900 border-r border-slate-800 w-64">
      {/* Logo */}
      <div className="flex h-16 items-center bg-slate-950 px-4">
        <div 
            ...
            return (
              ...
              >
                <item.icon
                  ...
                  aria-hidden="true"
                />
                <span className="ml-3 whitespace-nowrap opacity-100 w-auto">
                  {item.name}
                </span>
              </Link>
            )
      ...
      <div className="p-3 border-t border-slate-800 overflow-hidden">
        <div className="text-xs text-slate-500 text-center font-medium whitespace-nowrap">
          Powered by PhiNova
        </div>
      </div>
    </div>
