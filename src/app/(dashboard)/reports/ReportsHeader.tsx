...
import { 
  ...
  DollarSign, Wifi, Send, Layers, FileText, AlertTriangle, RotateCcw
} from 'lucide-react'
...
export default function ReportsHeader({
  ...
  // Build current query params to persist dates when switching tabs
  ...
  const TABS = [
    ...
    { id: 'logs', name: 'Dispatch Audit Log', href: '/reports/logs', icon: FileText },
    { id: 'anomalies', name: 'Phone Anomalies', href: '/reports/anomalies', icon: AlertTriangle },
    { id: 'retry', name: 'Retry Console', href: '/reports/retry', icon: RotateCcw },
  ] as const
          ...
          {TABS.map((tab) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2 px-4 py-3 border-b-2 text-xs sm:text-sm font-bold transition-all ${
                  isActive
