...
export default function AddTemplateForm() {
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white shadow-sm hover:shadow-md hover:scale-[1.03] active:scale-95 transition-all cursor-pointer"
 >
 ...
 <AIAssistantWidget
 onInsertDraft={(draft) => setContent(draft)}
 isOpen={showAI}
 setIsOpen={setShowAI}
 />
 </div>
